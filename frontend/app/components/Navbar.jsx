                ...
                <div className={`flex-1 items-center mt-8 md:mt-0 md:flex ${state ? 'block' : 'hidden'} `}>
                    <ul className="justify-center items-center,paddingTop:15px ,space-y-6 md:flex md:space-x-6 md:space-y-0">
                        {navigation.map((item, idx) => (
                            <li key={idx} className="text-white hover:text-black" style={{ fontSize: '1.5rem' }}>
                    ...
                    <div className="flex-1 gap-x-6 items-center justify-end mt-6 space-y-6 md:flex md:space-y-0 md:mt-0">
                        <a href="javascript:void(0)" style={{ fontSize: '1.5rem' }} className="block text-white hover:text-gray-900">
                            Log in
                        </a>
                        <a href="javascript:void(0)" style={{ fontSize: '1.5rem' }} className="flex items-center justify-center gap-x-1 py-2 px-4 text-white -medium bg-gray-800 hover:bg-gray-700 active:bg-gray-900 rounded-full md:inline-flex">
                            Sign in
